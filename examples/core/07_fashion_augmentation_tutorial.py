...
preprocessing stage alone, so each augmentation's own cost is the difference from it.
"""
...
Per-batch pipeline latency on an NVIDIA L40S, 64 samples per batch, 20 batches after warm-up:
