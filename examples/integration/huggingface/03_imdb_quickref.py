...
1. Load IMDB dataset using `HFSource` with streaming
...
print("Pipeline: HFSource(IMDB) -> TextStats -> Output")
...
- **API Reference**: [HFSource](https://datarax.readthedocs.io/sources/hf/)
"""
