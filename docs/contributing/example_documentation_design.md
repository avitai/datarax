...
This document defines comprehensive standards for documenting Datarax examples and
...
| "I've never used Datarax before" | Tier 2 | Needs guided introduction |
...
│       ├── core/
│       │   ├── simple-pipeline.md           # Docs for simple pipeline example
...
│       └── advanced/
│           ├── distributed/
│           │   └── sharding-quickref.md     # Docs for sharding example
│           ├── checkpointing/
│           │   └── checkpoint-quickref.md   # Docs for checkpointing
│           └── monitoring/
│               └── monitoring-quickref.md   # Docs for monitoring
│
├── examples/                                # Runnable code files
│   ├── README.md                            # Examples overview
│   ├── EXAMPLES_GUIDE.md                    # Detailed examples guide
│   ├── _templates/
│   │   └── example_template.py              # Template for new examples
│   │
│   ├── core/
│   │   ├── 01_simple_pipeline.py            # Tier 1: Quick Reference
│   │   ├── simple-pipeline.md         # Generated notebook
...
| `examples/` | `NN_snake_case.ipynb` | `simple-pipeline.md` |
...
- **Jupyter Notebook**: [`examples/core/simple-pipeline.md`](https://github.com/avitai/datarax/blob/main/examples/core/simple-pipeline.md)
...
```bash
jupyter lab examples/core/simple-pipeline.md
```
...
| TFDS | N/A | `tfds.load()` | N/A | `TFDSSourceModule` |
...
flowchart TD
    subgraph DataSource["Data Source"]
        DS[MemorySource / HuggingFaceSource / TFDSSource]
    end
...
Reference: `examples/core/01_simple_pipeline.py`
...
[Comprehensive overview of the advanced topic, including:
...
| Rule | Example |
|------|---------|
| Use Oxford comma | "sources, operators, and batchers" |
| Capitalize proper nouns | "Datarax", "JAX", "NumPy" |
| Use code formatting for code | "`from_source()`", "`MemorySource`" |
| Spell out numbers under 10 | "three operators", "15 batches" |
...
│                                                                              │
│  PHASE 1: PLANNING                                                          │
│  ├── Identify target audience and tier                                      │
│  ├── Define 3-5 learning objectives                                         │
│  ├── Outline major sections                                                 │
│  └── List prerequisites and dependencies                                    │
│                                                                              │
│  PHASE 2: CONTENT CREATION                                                  │
│  ├── Write setup section with verified installation                         │
│  ├── Implement code sections with expected outputs                          │
│  ├── Add explanatory markdown between code cells                           │
│  └── Include troubleshooting for known issues                              │
│                                                                              │
│  PHASE 3: ENHANCEMENT                                                       │
│  ├── Add visual elements (diagrams, tables, callouts)                      │
│  ├── Include metrics and performance data                                  │
│  ├── Write next steps and related content links                            │
│  └── Create main() function for CLI execution                              │
│                                                                              │
│  PHASE 4: REVIEW & TESTING                                                  │
│  ├── Execute complete example end-to-end                                   │
│  ├── Verify all expected outputs match                                     │
│  ├── Test on CPU and GPU (if applicable)                                   │
│  ├── Generate Jupyter notebook with Jupytext                               │
│  └── Peer review against quality checklist                                 │
│                                                                              │
└─────────────────────────────────────────────────────────────────────────────┘
```
...
Contributors should use the template at `examples/_templates/example_template.py`
...
|---------|----------|--------------|
| Simple Pipeline | `examples/core/01_simple_pipeline.py` | Ideal quick reference structure |
| HuggingFace Quick Ref | `examples/integration/huggingface/01_hf_quickref.py` | Integration quick reference |
| Sharding Quick Ref | `examples/advanced/distributed/01_sharding_quickref.py` | Advanced quick reference |

### Tier 2 Exemplars

| Example | Location | Demonstrates |
|---------|----------|--------------|
| Pipeline Tutorial | `examples/core/02_pipeline_tutorial.py` | Comprehensive tutorial format |
| Operators Tutorial | `examples/core/03_operators_tutorial.py` | Deep-dive tutorial |

### Template

| File | Purpose |
|------|---------|
| `examples/_templates/example_template.py` | Starting point for new examples |

### Documentation Pages

| Page | Location | Purpose |
|------|----------|---------|
| Examples Overview | `docs/examples/overview.md` | Entry point with navigation cards |
| Simple Pipeline Docs | `docs/examples/core/simple-pipeline.md` | Documentation for simple pipeline |

---

*This framework was adapted from the Workshop repository's documentation design
standards, contextualized for Datarax's data pipeline domain.*
