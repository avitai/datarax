...
- Stochastic modules **require** a `stream_name` for RNG management
...
- [HF Source](../sources/hf_source.md) - HfDataSourceConfig
- [TFDS Source](../sources/tfds_source.md) - TfdsDataSourceConfig
