...
mnist_config = TfdsDataSourceConfig(
    ...
    shuffle=True,
    stochastic=True,
    stream_name="mnist_shuffle",
)
mnist_source = TFDSSource(mnist_config, rngs=nnx.Rngs(42, mnist_shuffle=42))
...
fashion_config = TfdsDataSourceConfig(
    ...
    shuffle=True,
    stochastic=True,
    stream_name="fashion_shuffle",
)
fashion_source = TFDSSource(fashion_config, rngs=nnx.Rngs(43, fashion_shuffle=43))
