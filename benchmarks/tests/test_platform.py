...
class TestEstimateScenarioMemoryMB:
    ...
    def test_small_image_dataset(self):
        ...
        mb = estimate_scenario_memory_mb(
            dataset_size=10_000, element_shape=(32, 32, 3),
        )
    ...
    def test_tiny_tabular_dataset(self):
        ...
        mb = estimate_scenario_memory_mb(
            dataset_size=10_000, element_shape=(100,),
        )
    ...
    def test_large_image_dataset(self):
        ...
        mb = estimate_scenario_memory_mb(
            dataset_size=200_000, element_shape=(512, 512, 3),
        )
        assert mb > 500_000
    ...
    def test_custom_dtype_bytes(self):
        ...
        mb_f32 = estimate_scenario_memory_mb(
            dataset_size=1000, element_shape=(100,), dtype_bytes=4,
        )
        mb_i8 = estimate_scenario_memory_mb(
            dataset_size=1000, element_shape=(100,), dtype_bytes=1,
        )
...
class TestCanRunScenario:
    ...
    def _make_variant(
        self, dataset_size: int, element_shape: tuple[int, ...],
    ) -> ScenarioVariant:
