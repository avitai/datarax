...
# Script to run examples on GPU
# Usage: bash run_gpu_examples.sh

# Set up environment for GPU
export JAX_PLATFORMS="cuda"
export XLA_PYTHON_CLIENT_MEM_FRACTION=0.5 # Limit memory usage to avoid OOM errors
...
run_example() {
    ...
    python "$EXAMPLES_DIR/$example_file"
    local result=$?
